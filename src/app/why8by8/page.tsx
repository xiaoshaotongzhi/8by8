    ...
    return (
        <PageContainer>
            <div className={styles.why8by8}>
                <div className={styles.whyHero}>
                    <div className={styles.padding}>
                        ...
                        <q>
                            ...
                            yet there's limited media coverage. 8by8 gives me the opportunity
                            to use my skills to advance political and social equality for the
                            AAPI community and help increase voter turnout. The AAPI community
                    ...
                    <div className={styles.custom_shape_divider_top_1659139317}>
                        <svg
                            data-name="Layer 1"
                ...
                <div className={styles.tealStats}>
                ...
                <div className={styles.whiteMidsection}>
                    <Image
                        src={TealCurve}
                        className={styles.tealCurve}
                        alt="Teal Curve"
                    ></Image>
                    <q>
                    ...
                    <div className={styles.lastStat}>
                        ...
                        <Image src={BlurBlob} className={styles.blurBlob} alt="Blur Blob" />
                    </div>
                </div>
                <div className={styles.finalTealStats}>
                ...
                <div className={styles.closingQuotes}>
                    <q>
                        ...
                        peers, I wanted to help but didn't know how. Luckily I found 8by8,
                        and I resonated with their goal to protect AAPI rights through voter
                        registration.
                    </q>
                    <aside>
                        <span>—Luis, College Student</span>
                        <Image className={styles.img1} src={Luis} alt="Luis"></Image>
                    </aside>
                    ...
                    <div className={styles.chefusQuote}>
                        <Image
                            src={TealBottom}
                            className={styles.tealBottom}
                            alt="Teal Bottom"
                        />
                        <q>
                        ...
                        <Image src={TealTop} className={styles.tealTop} alt="Teal Top" />
                    </div>
                </div>
